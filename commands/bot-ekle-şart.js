...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    .setColor("808080")
    .setFooter({ text: `Bot Ekletme Şartları`, iconURL: 'https://media.discordapp.net/attachments/1064266014671503380/1068234418201825320/wB4SYe8GAAhThFpK5m7Bow2Bp_lHE3CoWfMMcu2lrM4rK7Z6S0c3nUXTOKCtPlRKrCTQQCoHNaJEzBeiYK45rP3n.jpg?width=414&height=414' })
