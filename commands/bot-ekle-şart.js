...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    .setAuthor({ name: `Duster Bot Ekleme Kuralları`, iconURL: 'https://media.discordapp.net/attachments/1022843509016895568/1033978189078331392/f5e9db50825d34cd7bbe85a46091c791.png?width=316&height=316' })
    ...
    .setColor("808080")
    .setFooter({ text: `Bot Ekletme Şartları`, iconURL: 'https://media.discordapp.net/attachments/1064266014671503380/1068234418403160145/Dash_Blue_D_Logo.png?width=281&height=281' })
