...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    .setAuthor({ name: `Güncel Ping | Duster!`, iconURL: 'https://media.discordapp.net/attachments/1064266014671503380/1064266269907492994/IMG_7693.gif?width=434&height=434' })
