...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    .setAuthor({ name: `Yardım menüsü | Duster!`, iconURL: 'https://media.discordapp.net/attachments/1064266014671503380/1068234418403160145/Dash_Blue_D_Logo.png?width=281&height=281' })
    ...
    .setColor("808080")
    .setFooter({ text: `Duster • #data#9999 Net`, iconURL: 'https://media.discordapp.net/attachments/1064266014671503380/1068234418403160145/Dash_Blue_D_Logo.png?width=281&height=281' })
